...
\begin{figure}
	...
	\caption{3 toy examples, with the number of tours $p \in \{2,3,4\}$. Tours are in the same color, line have a unique letter, and each stop a unique combination of a letter and a number. Clusters of nodes represent positions where transfer between tours are possible.}
\end{figure}
