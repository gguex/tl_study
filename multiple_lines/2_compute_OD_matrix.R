...
# Print top transfers 
agr_passengers = aggregate(line_df$passengers_in, list(line_df$line_nbr), FUN=sum)
agr_passengers_stop = aggregate(line_df$passengers_in, list(line_df$line_nbr), FUN=sum) 
